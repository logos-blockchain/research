...
| --- | --- | --- |
| does adoption speed matter? | **a hump**: 707 / 5,682 / 4,646 elevated at 2 / 100 / 500 per epoch under persistence (worst = an eighth of best), 800 / 25,934 / 14,398 under retirement (a thirty-second) — measured at 400 epochs and gated | **no**: 24,707 / 26,020 / 25,266 bonds under uniform, ×10 and ×100 arrivals if miners retire; 7,963 / 8,027 / 7,384 if they do not — a third of the level either way, but flat across the shape in **both** regimes |
