...
![Fig B1 — per-epoch (D̂/D − 1) in per-mil at U=0, k=2160: the zero-delay and sub-slot-gossip series wander inside the ±σ_th = √((1−f)/fT) sampling-noise band around the ≤1 equilibrium.](report-figures/figB1_fluctuation_trace.png)
...
![Fig 17 — at N=10000, per-node D̂/D spread stays ≡ 0 and window agreement ≡ 1.000 across all 30 epochs, even as current-tip agreement stays below 1.](report-figures/fig17_divergence.png)
...
![Fig 18 — current-tip agreement at N=10000 is high but below 1 (≈ 0.985–0.994 typical, ~0.985 worst cell); the transient tip forking it measures never propagates into D̂.](report-figures/fig18_tip_agreement.png)
